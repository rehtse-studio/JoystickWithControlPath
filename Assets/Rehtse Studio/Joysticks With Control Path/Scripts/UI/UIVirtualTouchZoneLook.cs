...
{
    public class UIVirtualTouchZoneLook : OnScreenControl, IPointerDownHandler, IPointerUpHandler, IDragHandler
    {
        ...
        public void OnDrag(PointerEventData _dragData)
        {
            ...
            OutputValue(new Vector2(_dragData.delta.normalized.x, _dragData.delta.normalized.y));
        }
